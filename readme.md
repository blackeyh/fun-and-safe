...
|-------|---------------------|----------------------------------------------|------------------------|
| 1     | 🔥 Fire              | Avoid flames and smoke hazards               | ![](fire.png)          |
| 2     | 🌊 Water & Drowning | Stay away from deep water & unsupervised areas | ![](level2.png)        |
| 3     | 🚗 Cars & Roads      | Learn road safety and avoid moving vehicles  | ![](level3.png)        |
| 4     | 🪨 Sharp Spikes      | Recognize and avoid harmful objects          | ![](level4.png)        |
| 5     | 🍕 Spoiled Food      | Identify and reject bad food                 | ![](level5.png)        |
| 6     | 🧸 Dangerous Toys     | Know the difference between safe and unsafe toys | ![](level6.png)    |
